...
class cliente_controlador{
    ...
    public function  principal(){
     ...
     public function registro(){
         $this->vista->unirContenido("cliente/registro");
    ...
    public function frmEditar(){
        $id = $_GET["id"];
      $this->vista->dato=cliente_modelo::mdlBuscarXID($id);
    ...
    public function editar(){
        ...
        $datos["documento"] = $documento;
        $datos["codigo"]    = $codigo;
        $rpta = cliente_modelo::mdlEditar($datos);
        if($rpta > 0){
    ...
    public function eliminar(){
        $id   = $_GET["id"];
        $r    = cliente_modelo::mdlEliminar($id);
        if($r > 0){
