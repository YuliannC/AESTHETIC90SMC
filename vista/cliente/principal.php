...
<div class="promo">
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center"><br>
						<div class="section_title">ADMINISTRACION DE CLIENTES</div>
			...
			<div class="input-group input-group-outline mb3">
                  ...
                  <input type="text" class="search_input menu_mm"name="apellidos" id="apellidos" placeholder="Buscar cliente por apellido">
          </div>
		  <br><br>
