        ...
        <div class="col-12">
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              ...
              <br><br><br><br>
                <h6 class="text-white text-capitalize ps-3">REGISTRO USUARIO</h6>
              </div>
            </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-3">
                    <form action="?controlador=cliente&accion=Registrar" autocomplete="off" id="frmRegistro" method="post">
