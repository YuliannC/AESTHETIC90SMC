		...
		<div class="container">
			<div class="row">
				<div class="col text-center">
					<div class="footer_logo"><a href="#">Aesthetic 90s Mc</a></div>
					<nav class="footer_nav">
						<ul>
							<li><a href="index.html">Inicio</a></li>
							<li><a href="categories.html">Prendas</a></li>
							<li><a href="categories.html">Asesoria personalizada</a></li>
					...
					<div class="footer_social">
						<ul>
							...
							<li><a href="#"><i class="fa fa-tik-tok" aria-hidden="true"></i></a></li>
						</ul>
					</div>
